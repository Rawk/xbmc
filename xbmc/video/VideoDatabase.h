...
protected:
  ...
  void AddCast(int idMedia, const char *table, const char *field,
  ...
  void GetCast(const CStdString &table, const CStdString &table_id,
               int type_id, std::vector<CActorInfo> &cast);
